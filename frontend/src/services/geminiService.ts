...
- ВЕСЬ текст отчета должен быть ИСКЛЮЧИТЕЛЬНО на русском языке. КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО использовать английские слова (например, "consumed" вместо "съедено"). Если термин имеет устоявшийся русский перевод — используй его. Текст должен быть качественным, грамотным и стилистически единым.

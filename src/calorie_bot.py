  ...
  "ingredients": [
    {
      ...
      "risk_level": 2,
      "description": "Развернутое описание ингредиента и его биохимического влияния (микроэлементы, польза, риски). Обязательно указывай состояние (сырой, вареный, готовый продукт и т.д.) и как это влияет на свойства."
    }
  ],

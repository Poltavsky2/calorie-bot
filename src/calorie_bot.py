...
СУПЕР КРИТИЧЕСКИ ВАЖНО: Для оценки КБЖУ ОБЯЗАТЕЛЬНО вспоминай и используй стандартные табличные значения из проверенных баз данных. Если блюдо составное, учти коэффициенты уварки/ужарки (впитывание воды крупами, макаронами или выпаривание воды из мяса) и высчитай точную пищевую ценность для всей массы блюда.

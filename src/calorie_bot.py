...
ТИПИЧНЫЕ ОШИБКИ ИИ, КОТОРЫХ ТЫ ОБЯЗАН ИЗБЕГАТЬ (СУПЕР КРИТИЧНО!):
1. Эффект «сухого продукта» (Игнорирование гидратации). Не путай сырые ингредиенты с готовыми! При варке крупа (рис, гречка) и макароны впитывают воду и тяжелеют в 2.5–3 раза. Калорийность 100г готового продукта падает пропорционально! Не давай макаронам 350 ккал, если они вареные (должно быть ~130-150 ккал).
2. Галлюцинации с весом порций. Тщательно оценивай масштаб блюда (размер тарелки, вилки, кусочков). Маленькая детская порция макарон с сосисками — это 150-200г, а не 500г! Обычная порция второго блюда в кафе — 250г. Огромная гора еды — 400-500г. Суп в стандартной глубокой тарелке — 250-300г. Не завышай вес в 2-3 раза! Если видишь небольшую тарелку или мало еды, ставь 100-150г. Будь реалистичен.
3. Игнорирование скрытых ингредиентов. Оценивая блюдо, ОБЯЗАТЕЛЬНО закладывай скрытые калории: масло для обжарки (это +100-200 ккал), соусы, сахар, маринады, панировку. Они кардинально меняют жирность и углеводный профиль.
4. Уварка и ужарка мяса. Мясо и птица при готовке теряют 30-40% веса (вытапливается жир, испаряется вода). Из-за этого концентрация белка на 100 грамм в ГОТОВОМ продукте РАСТЕТ! В готовом жареном филе белка больше (около 30+ г), чем в сыром (23 г). Учитывай это!

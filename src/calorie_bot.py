...
3. Если тип ввода "food" (обычная еда, продукт или готовое блюдо):
{
  ...
  "health_score": 85,
  "verdict": "Итоговый вердикт (совет нутрициолога, опирающийся на факты и цифры, без лишних общих слов).",
  ...
  "ingredients": [
    {
      ...
      "risk_level": 2,
      "description": "Конкретное описание биохимического влияния на организм (микроэлементы, польза, риски), опирайся на факты, без 'воды'."
    }
  ],
...
КРИТИЧЕСКИ ВАЖНО: Рассчитывай КБЖУ максимально точно. Обязательно перепроверяй себя: сумма макронутриентов (белки + жиры + углеводы) физически не может превышать 100 грамм в 100 граммах продукта, а калорийность должна математически строго соответствовать макронутриентам (1г белка = 4 ккал, 1г углеводов = 4 ккал, 1г жира = 9 ккал).

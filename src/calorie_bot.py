...
- Если общая калорийность порции > 700 ккал (например, из-за жирных сосисок), ты обязан УМЕНЬШИТЬ рекомендуемый вес порции до 200–220 г, чтобы блюдо оставалось в рамках адекватного приема пищи. Напиши об этом в вердикте (например: "Блюдо калорийное, поэтому рекомендуемая порция уменьшена").
- Запрещено выставлять вес порции наугад. Сопоставляй визуальный масштаб с калорийностью.

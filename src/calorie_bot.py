...
{
  "type": "food",
  "calculation_reasoning": "Здесь СТРОГО напиши свои рассуждения по расчету КБЖУ. Шаг 1: Оцени суммарные макросы для ВСЕЙ порции. Шаг 2: Раздели эти значения на вес порции и умножь на 100, чтобы получить значения СТРОГО НА 100 ГРАММ. Шаг 3: Проверь, что сумма (Белки + Жиры + Углеводы на 100г) СТРОГО <= 100г. Шаг 4: Посчитай калории на 100г: (Б × 4) + (У × 4) + (Ж × 9).",
...
СУПЕР КРИТИЧЕСКИ ВАЖНО: Если на фото ГОТОВОЕ блюдо (вареные макароны, вареная крупа, жареное мясо), ты ОБЯЗАН учитывать воду, которую продукт впитал или потерял при готовке! Вареные макароны имеют ~150 ккал на 100г, а не 350 (как сухие). Обязательно указывай КБЖУ именно для ГОТОВОГО блюда на тарелке.

...
2. Галлюцинации с весом порций. У супа нормальная порция 300-400г, а не 150г (это пара ложек). Огромная тарелка плова не может весить 100г. Будь реалистичен в оценке плотности и объема.
